...
def export_mask_as_shapefile(mask, profile, out_path):
    """
    Export a boolean or integer mask as a Shapefile using rasterio.features and geopandas.
    """
    import geopandas as gpd
    from rasterio import features
    from shapely.geometry import shape
    ...
    print(f"Exported Shapefile: {out_path}") 